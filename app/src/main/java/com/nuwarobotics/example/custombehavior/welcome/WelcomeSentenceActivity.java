...
public class WelcomeSentenceActivity extends AppCompatActivity {
    ...
    public void BtnStart(View view) {
        setText("Start Service: " + this.getPackageName() + ".welcome.CustomService", false);
        Intent intent = new Intent();
        intent.setClassName(this.getPackageName(), this.getPackageName() + ".welcome.CustomService");
        startForegroundService(intent);
    }

    public void BtnStop(View view) {
        setText("Stop Service: " + this.getPackageName() + ".welcome.CustomService", false);
        Intent intent = new Intent();
        intent.setClassName(this.getPackageName(), this.getPackageName() + ".welcome.CustomService");
        stopService(intent);
    }
