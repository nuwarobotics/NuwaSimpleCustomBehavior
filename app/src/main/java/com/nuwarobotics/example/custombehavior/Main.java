...
import com.nuwarobotics.example.custombehavior.util.AIPermissionRequest;
import com.nuwarobotics.example.custombehavior.util.ActivityBean;
import com.nuwarobotics.example.custombehavior.util.ActivityUtils;
...
/**
 * This is demo function select list, just use to start example activity.
 */
